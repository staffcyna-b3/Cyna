...
import { getProfile, UserApiError, type UserProfile } from '@/services/userService';
import { getAddresses, AddressApiError, type Address } from '@/services/addressService';
